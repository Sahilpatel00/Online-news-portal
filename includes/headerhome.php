      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="account.php" <?php echo ($_SESSION['status'] == 0) ? 'style="display:none;"' : '' ?>>Account</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="login.php" <?php echo ($_SESSION['status'] == 1) ? 'style="display:none;"' : '' ?>>Login</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="logout.php"<?php echo ($_SESSION['status'] == 0) ? 'style="display:none;"' : '' ?>>Logout</a>
            </li>
          </ul>
        </div>
      </div>
