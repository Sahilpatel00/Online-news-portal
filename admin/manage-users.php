...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"delete from  tbluser  where username='$username'");
echo "<script>alert('Users details deleted.');</script>";
...
<td>
    <a href="sendmail.html?said=<?php echo htmlentities($row['id']);?>"><i class="fa fa-envelope" style="color: #29b6f6;"></i></a>
